...
public class DataLocalManager {
    ...
    // get instance if it is created else if we create new instance
    ...
    //TODO delete the old list and add a new list to this to avoid duplication in the process of adding and deleting new photos
